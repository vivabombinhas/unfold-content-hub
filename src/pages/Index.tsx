...
const Index = () => {
  ...
  return (
    <div className="bg-brand-black text-brand-text-light min-h-screen">
        ...
        <div className="container-editorial relative z-[2] grid lg:grid-cols-[1.1fr_1fr] gap-10 lg:gap-20 items-center pt-16 pb-20 md:pt-24 md:pb-28 lg:py-32">
          <div className="reveal">
            ...
            <h1 className="h-display-1 mt-6 text-balance">
              ...
              <br className="hidden sm:block" /> não para parecer{" "}
              <em>outra pessoa</em>.
            </h1>
            <span className="gold-rule mt-7" />
            <p className="mt-7 text-brand-text-soft text-lg leading-[1.7] max-w-xl text-pretty">
              Protocolo de toxina botulínica com dosagem calibrada para a
              anatomia masculina. Sem aspecto congelado, sem perder a expressão
              que comunica autoridade. Avaliação individual, técnica
              documentada, resultado em 14 dias.
            </p>
          ...
          <div className="relative reveal mx-auto lg:mx-0 w-full max-w-md lg:max-w-none">
            <div className="aspect-[4/5] overflow-hidden bg-brand-graphite relative">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, transparent 50%, hsl(0 0% 0% / 0.6) 100%)",
                }}
              />
            </div>
            {/* Floating medal */}
            ...
            <div className="absolute bottom-5 left-5 right-5 flex items-end justify-between gap-4">
              <div>
                <p className="text-[10px] uppercase tracking-[0.22em] text-brand-gold">
                  Caso documentado
                </p>
                <p className="font-display italic text-xl text-brand-text-light mt-1">
                  44 anos · 14 dias
                </p>
              </div>
              <button
                onClick={() => setOpenCase(featuredCases[0])}
                className="size-12 rounded-full bg-brand-gold text-brand-green grid place-items-center hover:scale-110 transition-transform"
                aria-label="Ver caso"
              >
      ...
      {/* ========================================================
          AUTHORITY STRIP
          Faixa enxuta com prova social condensada
          ======================================================== */}
      <AuthorityStrip />

      {/* ========================================================
          MANIFESTO CURTO + abrir manifesto completo (side-sheet)
          ======================================================== */}
        ...
        <div className="container-editorial grid lg:grid-cols-[1fr_1.4fr] gap-10 lg:gap-20 items-start">
          ...
          <div className="reveal">
            <p className="font-display text-2xl md:text-3xl lg:text-[2rem] leading-[1.3] text-brand-text-light text-balance">
              "Não tratamos o homem como uma versão masculina do protocolo
              feminino. <em>Anatomia diferente, dose diferente, vetor diferente.</em>{" "}
              Trinta anos depois, o que entregamos é coerência: a mesma cara,
              só sem a marca do cansaço."
            </p>
            <p className="mt-6 text-sm text-brand-text-muted uppercase tracking-[0.2em]">
              Dra. Daniele Florencio · RT
            </p>
            <button
      ...
      {/* ========================================================
          MÉTODO em 3 passos com inline expand
          ======================================================== */}
      <MethodSection />

      {/* ========================================================
          CASOS — vitrine + biblioteca (side-sheet) + modal fullscreen
          ======================================================== */}
        ...
        <div className="container-editorial">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
            ...
            <button
              ...
              className="self-start inline-flex items-center gap-3 text-brand-green text-[11px] font-body font-semibold uppercase tracking-[0.2em] border-b border-brand-green/40 pb-1 hover:border-brand-green transition-colors group"
            >
      ...
      {/* ========================================================
          PREÇO ÂNCORA — card simples + side-sheet com slot custom
          ======================================================== */}
      <section id="precos" className="bg-brand-green-2 section-pad relative z-[2]">
        <div className="container-editorial max-w-3xl mx-auto text-center">
          ...
          <h2 className="h-display-2 mt-5 reveal text-balance">
          ...
          <p className="mt-7 text-brand-text-soft text-lg leading-relaxed max-w-xl mx-auto reveal">
            Inclui avaliação clínica completa, aplicação por responsável
            técnica, retorno de 14 dias e ajuste fino sem custo adicional.
          </p>
          ...
          <div className="mt-10 flex flex-wrap gap-3 justify-center reveal">
            <GoldButton onClick={() => setPriceOpen(true)} withArrow>
              Entender o preço em detalhe
            </GoldButton>
            <GoldButton as="a" href="https://wa.me/5541999999999" variant="outline-light">
              Falar agora
            </GoldButton>
          </div>
        </div>
      ...
      {/* ========================================================
          DEPOIMENTOS / GOOGLE REVIEWS (carrossel horizontal)
          ======================================================== */}
      <ReviewsSection />

      {/* ========================================================
          O QUE AS IAs DIZEM (scroll horizontal editorial)
          ======================================================== */}
      <AISection />

      {/* ========================================================
          EQUIPE / RT — bloco compacto com side-sheet
          ======================================================== */}
      <section id="equipe" className="bg-brand-cream text-brand-text-dark section-pad relative z-[2]">
        <div className="container-editorial grid lg:grid-cols-[1fr_1.2fr] gap-10 lg:gap-16 items-center">
          <div className="relative reveal mx-auto w-full max-w-sm lg:max-w-none">
            ...
            <span className="absolute bottom-4 left-4 right-4 bg-brand-green text-brand-text-light px-5 py-3 text-[10px] font-body uppercase tracking-[0.2em]">
              CRBM 8242 PR
            </span>
          </div>
          <div className="reveal">
            ...
            <h2 className="h-display-2 mt-5 text-brand-text-dark text-balance">
              Dra. Daniele <em>Florencio</em>
            </h2>
            <span className="gold-rule mt-7" />
            <p className="mt-7 text-brand-text-dark/80 leading-[1.7]">
              Biomédica esteta com mais de duas décadas dedicadas à harmonização
              facial. Desenvolveu, ao longo dos anos, um protocolo proprietário
              de aplicação de toxina botulínica em pacientes masculinos.
            </p>

            <div className="mt-7 space-y-1">
              <InlineExpand tone="cream" question="Como a Dra. Daniele pensa o protocolo masculino">
                <p>
                  "O homem médio chega com franzimento de glabela mais marcado e
                  pele mais espessa. Se eu replicar dose feminina, ele perde o
                  movimento natural. O caminho é dose progressiva, registrada,
                  com retorno em 14 dias para ajuste fino."
                </p>
              </InlineExpand>
      ...
      {/* ========================================================
          CURSOS E MENTORIAS — autoridade técnica para o EEAT
          ======================================================== */}
          ...
          <div className="grid lg:grid-cols-[1fr_2fr] gap-10 lg:gap-16">
            <div className="reveal">
              ...
              <h2 className="h-display-2 mt-5 text-balance">
                Ensinamos o que <em>praticamos</em>.
              </h2>
              <span className="gold-rule mt-6" />
              <p className="mt-6 text-brand-text-soft leading-[1.7]">
                Nossa metodologia é aberta para outros profissionais. Mentorias
                presenciais e cursos para quem quer dominar protocolos de
                injetáveis com base clínica sólida.
              </p>
              <p className="mt-4 text-brand-text-muted text-sm">
                Acreditamos que o setor cresce quando os profissionais elevam o
                padrão técnico em conjunto.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {courses.map((c) => (
                <article
                  key={c.title}
                  className="reveal group bg-brand-black/40 border border-brand-gold/15 p-7 hover:border-brand-gold/50 hover:bg-brand-black/60 transition-all duration-500"
                >
      ...
      {/* ========================================================
          FAQ — 5 visíveis + expandir todas (todas no DOM, indexadas)
          ======================================================== */}
      <section id="faq" className="bg-brand-black section-pad relative z-[2]">
        <div className="container-editorial max-w-4xl mx-auto">
          <div className="text-center reveal">
            ...
            <h2 className="h-display-2 mt-5 text-balance">
              O que pacientes perguntam <em>antes</em> de agendar.
            </h2>
            <span className="gold-rule mx-auto mt-7" />
          </div>
          ...
          <div className="mt-14">
            ...
            <div
              className={cn(
                ...
                showAllFaqs ? "max-h-[3000px] opacity-100" : "max-h-0 opacity-0"
              )}
          ...
          {restFaqs.length > 0 && (
            <div className="text-center mt-10">
              <button
                ...
                className="inline-flex items-center gap-3 text-brand-gold text-[11px] font-body font-semibold uppercase tracking-[0.2em] border-b border-brand-gold/40 pb-1 hover:border-brand-gold transition-colors"
              >
      ...
      <section id="avaliacao" className="bg-brand-green section-pad relative z-[2] overflow-hidden">
        <div
          ...
          style={{
            background: "radial-gradient(ellipse 60% 50% at 50% 100%, hsl(41 49% 58% / 0.2), transparent 70%)",
          }}
        />
        <div className="container-editorial relative z-[2] max-w-3xl mx-auto text-center">
          ...
          <p className="mt-7 text-brand-text-soft text-lg leading-relaxed">
            Avaliação clínica individual, sem compromisso, com a responsável
            técnica. Você sai com plano e orçamento.
          </p>

    ...
    extend: {
      colors: {
        ...
        brand: {
          ...
          graphite: "hsl(var(--bg-graphite))",
          green: "hsl(var(--bg-green))",
          "green-2": "hsl(var(--bg-green-2))",
          cream: "hsl(var(--bg-cream))",
          "cream-2": "hsl(var(--bg-cream-2))",
          bordeaux: "hsl(var(--bg-bordeaux))",
          gold: "hsl(var(--gold))",
      ...
      animation: {
        ...
        "slide-in-up": "slide-in-up 500ms cubic-bezier(0.22, 1, 0.36, 1) both",
        "scale-in": "scale-in 500ms cubic-bezier(0.22, 1, 0.36, 1) both",
        "float-medal": "float-medal 4s ease-in-out infinite",
      },
    },
  },
